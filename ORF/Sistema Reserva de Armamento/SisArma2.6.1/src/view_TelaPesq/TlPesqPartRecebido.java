 ...
 * @author Asus
 */
public class TlPesqPartRecebido extends javax.swing.JInternalFrame {

    int contador = 0;

    public TlPesqPartRecebido() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)), "Armamento Particular Recebido ", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial", 1, 16))); // NOI18N
            ...
            if (lista.isEmpty()) {
                ...
                for (ItemParticular i : lista) {
                    tabela.addRow(new Object[]{
                        ...
                        i.getDataentrada(),
                        i.getResponsavelEntrada().getLogin(),});
                    contador++;
