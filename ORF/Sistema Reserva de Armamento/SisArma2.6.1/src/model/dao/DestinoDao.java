...
private ResultSet rs;           // retorna a consulta no banco de dados
    ...
    public List<Destino> listEntidade() throws Exception {
    Destino des = null;                               //Declarao classe cria um variavel e atribe o valor null;
    ...
    while(rs.next()){                           //cria condição enquanto resultado existe executa proximo passo 
        des = new Destino();                          //estância o objeto
