 ...
 * @author Asus
 */
public class TlHistoricoMilitar extends javax.swing.JDialog {

    public TlHistoricoMilitar(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        texto2.setText("o histórico de cautela.");
    ...
    private void jTidentidadeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTidentidadeActionPerformed
        ...
        try {
            dispose();
            rl.historicoMilitar(identidade);
        } catch (JRException ex) {
            JOptionPane.showMessageDialog(null, "ERRO AO GERAR RELATÓRIO");
            Logger.getLogger(TlHistoricoMilitar.class.getName()).log(Level.SEVERE, null, ex);
        }
